        ...
        <v-card elevation="0" color="transparent">
          ...
          <v-card-text>
            <h1 style="line-height: 2rem">
              I'm Mohamed Gamal
              <span class="text-amber">Front-End Developer</span>
            </h1>
          </v-card-text>
          <v-card-text>
            <p
          ...
          <!-- <img :height="height" src="../../../public/favicon.ico" alt="" /> -->
          <v-card-actions>
            <v-row>
              <v-col cols="auto">
                <v-btn
              ...
              <v-col cols="auto">
                <v-btn color="primary" size="x-large" class="custom-btn"
      ...
      <v-col cols="12" xs="6" sm="6" lg="5" xl="5" class="text-center">
        <VCard color="transparent" elevation="0">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
            ...
            <g id="freepik--Lines--inject-189">
              <path
                ...
                style="
                  ...
                  stroke-width: 1.10311px;
                  stroke-dasharray: 4.41241979598999;
                "
              ></path>
              <path
            ...
            <g id="freepik--Window--inject-189">
              <path
...
/* Large screen styles (e.g., desktop) */
